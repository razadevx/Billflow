...
export async function GET(_request: NextRequest) {
  try {
    ...
    const result = await service.getTodayWorkOrders(context.companyId);
    ...
    return errorResponse((error as Error).message || "Failed to fetch today work orders", "INTERNAL_ERROR", 500);
  }
}
