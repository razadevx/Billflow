...
export async function GET(_request: NextRequest) {
  try {
    ...
    const result = await service.getActivityFeed(context.companyId);
    ...
    return errorResponse((error as Error).message || "Failed to fetch dashboard activity", "INTERNAL_ERROR", 500);
  }
}
